...
public class Voiture {
    ...
    public void entreAuGarage(Garage g) throws Exception {
        ...
        } else throw new IllegalArgumentException("La voiture ne doit pas être dans un garage");
    }
    ...
    public Set<Garage> garagesVisites() {
        Set<Garage> garageVisit = new HashSet<>();
        for (Stationnement s : myStationnements) {
            garageVisit.add(s.getGarage());
        }
        return garageVisit;
    }
    ...
    public void imprimeStationnements(PrintStream out) {
        Set<Garage> garagesDejaVisit = garagesVisites();
        for (Garage g : garagesDejaVisit) {
            out.println(g);
            for (Stationnement s : myStationnements) {
